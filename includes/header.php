...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="headmain">
            <div class="navbar-header" id="ncolor">
                ...
                <a class="navbar-brand" href="index.php">income & expense tracker</a>
                <?php echo $_SESSION['imglink']; ?>
                <div class="navbar-brand">
                  <?php echo $ColUser['FirstName']; ?>
                  <?php echo $ColUser[' ']; ?>
                  <?php echo $ColUser['LastName']; ?>
                </div>
            </div>
            <!-- /.navbar-header -->
